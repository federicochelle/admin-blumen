...
function RoomEventDetailModal({ event, open, onClose }) {
  ...
  return (
    <>
      <button
        type="button"
        aria-label="Cerrar modal detalle del evento de sala"
        onClick={onClose}
        ...
        <section className="w-full max-w-2xl rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-[0_24px_60px_rgba(15,23,42,0.18)]">
          ...
          <div className="mt-5 space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              {event?.created_by ? <DetailField label="Creado por" value={event.created_by} /> : null}
            </div>
...
export default RoomEventDetailModal
